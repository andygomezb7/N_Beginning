...
/*
* ------------------------------------------------
* @Tittle  "New Beginning PHP script BETA".
* @Versión 0.3
* @Author: Andy Gómez /By Wortit
* @Date:  15/10/2016
* Derechos reservados 2016 - 2017
* ------------------------------------------------
*/

// VERSIÓN BETA, PARA SU USO EN MODO PRUEBA
// INSTRUCCIONES: Crear un archivo con nombre "connect_database.php para conectar la base de datos
// INSTRUCCIONES: Abrir este archivo y seguir los pasos
